...
$lang['start']['openemail_apps_detail'] = 'Tria una aplicació (de moment només SOGo) per a accedir als teus correus, calendari, contactes i més.';
$lang['start']['openemail_panel_detail'] = "Els <b>administradors del domini</b> poden crear, modificar o esborrar bústies i àlies, configurar i obtenir informació detallada sobre els seus dominis<br>
...
$lang['header']['openemail_settings'] = 'Configuració';
...
Filtre previ → Filtre d\'usuari → Filtre posterior → <a href="https://github.com/openemail/openemail-dockerized/blob/master/data/conf/dovecot/sieve_after" target="_blank">Filtre global</a>';

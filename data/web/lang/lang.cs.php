...
$lang['start']['openemail_apps_detail'] = 'Použijte openemail aplikace pro přístup k vašim e-mailům, kalendáři, kontaktům a dalším funkcím.';
$lang['start']['openemail_panel_detail'] = '<b>Administrátoři domén</b> mohou vytvářet, upravovat nebo mazat mailboxy a aliasy. Dále mohou upravovat parametry domény a zobrazovat další informace o jejich přidělených doménách.<br>
...
$lang['header']['openemail_settings'] = 'Nastavení';
...
<a href="https://github.com/openemail/openemail-dockerized/blob/master/data/conf/dovecot/global_sieve_before" target="_blank">Global sieve prefilter</a> → Prefilter → Uživatelské skripty → Postfilter → <a href="https://github.com/openemail/openemail-dockerized/blob/master/data/conf/dovecot/global_sieve_after" target="_blank">Global sieve postfilter</a>';

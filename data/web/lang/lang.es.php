...
$lang['footer']['restart_sogo_info'] = 'Algunas tareas, por ejemplo agregar un dominio, requieren que se reinicie SOGo para detectar cambios hechos en la UI de openemail.<br><br><b>Importante:</b> Un reinicio sencillo puede tardar un poco en completarse, por favor espera a que termine.';
...
$lang['start']['openemail_apps_detail'] = 'Utiliza una aplicación de openemail para acceder a tus correos, calendario, contactos y más.';
$lang['start']['openemail_panel_detail'] = '<b>Administradores por dominio</b> pueden crear, modificar o eliminar buzones y alias, modificar los dominios asignados y ver información más detallada sobre los dominios asignados<br>
...
$lang['header']['openemail_settings'] = 'Configuración';
...
$lang['add']['alias_address_info'] = '<small>Dirección(es) de correo completa(s) ó @dominio.com, para atrapar todos los mensajes para un dominio (separado por coma). <b>Dominios que existan en openemail solamente</b>.</small>';
...
$lang['admin']['r_inactive'] = 'Restricciones inactivas';
$lang['admin']['r_active'] = 'Restricciones activas';
$lang['admin']['r_info'] = 'Los elementos desactivados en la lista de restricciones activas no son reconocidas como restricciones válidas por openemail y no se pueden mover. <br>Se puede agregar nuevos elementos en <code>inc/vars.local.inc.php</code> para poder activarlos.';
...
$lang['admin']['title_name'] = '"openemail UI" (título de la página)';
$lang['admin']['main_name'] = 'Nombre "openemail UI"';
$lang['admin']['apps_name'] = 'Nombre "openemail Apps"';
...
$lang['tfa']['api_register'] = 'openemail utiliza la API de la nube de Yubico. Por favor, obtén una clave API para tu llave <a href="https://upgrade.yubico.com/getapikey/" target="_blank">aquí</a>.';
...
<a href="https://github.com/openemail/openemail-dockerized/blob/master/data/conf/dovecot/global_sieve_before" target="_blank">Prefiltro sieve global</a> → Prefiltro → Scripts del usuario → Posfiltro → <a href="https://github.com/openemail/openemail-dockerized/blob/master/data/conf/dovecot/global_sieve_after" target="_blank">Posfiltro sieve global</a>';
...
$lang['edit']['force_pw_update_info'] = 'Este usuario solo podrá iniciar sesión en la interfaz de usuario de openemail.';

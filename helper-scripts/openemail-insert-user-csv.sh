...
if [[ "$response" =~ ^(yes|y)$ ]]; then
  ...
  do
	...
	echo "Added to _sogo_static_view table"

	echo "
mailbox accounts successfully added to all required tables.
"
else
